angular.module('recruitApp', [ 'recruitApp.controller', 'recruitApp.directive', 'recruitApp.restful', 'ui.bootstrap' ]);
...
angular.module('recruitApp').run([ '$rootScope', '$location', function($rootScope, $location) {
    $rootScope.report = 0;
